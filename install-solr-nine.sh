...
mkdir -p /home/www-data/solr-tomcat
cd /home/www-data/solr-tomcat/
...
# download general configuration in /home/www-data/solr-tomcat/solr/typo3cores/conf/
...
# download core configuration file solr.xml in /home/www-data/solr-tomcat/solr/
cd ../..
rm solr.xml
...
cd /home/www-data/solr-tomcat/tomcat/conf
